Файлы:
allure_results - папка с отчетами о тестировании
tests/ - папка с автотестами
tests/test_home_page.py - автотест для проверки домашней страницы
tests/test_order_page.py - автотест для проверки оформления заказа
